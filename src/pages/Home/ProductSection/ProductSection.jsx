...
const ProductSection = ({
  ...
  const getCardClasses = () => {
    switch (cardStyle) {
      case "minimal":
        return "bg-white border border-slate-100 hover:border-amber-200 rounded-xl";
      case "featured":
        return "bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200/50 rounded-2xl shadow-lg hover:shadow-xl";
      default:
        return "bg-white border border-slate-100 hover:border-amber-200 rounded-xl shadow-sm hover:shadow-md";
    }
  };
